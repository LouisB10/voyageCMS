...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230104_voyage_6e6fc9776d3248772296_20230104134831_archive.zip';
        const ARCHIVE_SIZE       = '47968508';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '6e6fc97-04134831';
        const SECONDARY_PACKAGE_HASH = '5d29426-04134831';
        const VERSION            = '1.5.1';
